 ...
 * </p>
 * <ul>
 *   <li>{@link my.dsl.engineignition.impl.TimeEventImpl#getTime <em>Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeEventImpl extends MinimalEObjectImpl.Container implements TimeEvent {
	...
	protected EClass eStaticClass() {
		return EngineignitionPackage.Literals.TIME_EVENT;
	}
	...
	public void setTime(int newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EngineignitionPackage.TIME_EVENT__TIME, oldTime,
					time));
	}
